...
import com.example.haritmoolphunt.liveat500px.view.SlidingTabLayout;
...
public class MoreInfoFragment extends Fragment {
    ...
    public static MoreInfoFragment newInstance(PhotoListDao dao) {
    ...
    public void onCreateOptionsMenu(Menu menu,MenuInflater inflater) {
        ...
        android.support.v7.widget.ShareActionProvider shareActionProvider =  (android.support.v7.widget.ShareActionProvider)
